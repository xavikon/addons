...
function init_gear_sets()
	...
	-- Idle sets
	sets.idle = {head="Rawhide Mask",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
	...
	sets.engaged = {ammo="Ginsen",head={ name="Dampening Tam", augments={'DEX+4','Accuracy+10','Mag. Acc.+7',}},
