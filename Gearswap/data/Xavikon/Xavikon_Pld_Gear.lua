...
sets.engaged = {head="Sulevia's Mask",body="Cab. Surcoat +1",hands="Sulevia's Gauntlets",legs="Sulevia's Cuisses",
    feet="Sulev. Leggings +1",neck="Twilight Torque",waist="Windbuffet Belt +1",left_ear="Steelflash Earring",right_ear="Bladeborn Earring",
