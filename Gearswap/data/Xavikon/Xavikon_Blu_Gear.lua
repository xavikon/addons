...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Ginsen",
                  ...
                  body="Adhemar Jacket",hands="Jhakri Cuffs +1",ring1="Epona's Ring",ring2="Rajas Ring",
				  back=gear.melee_jse_back,waist="Fotia Belt",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
	...
	sets.precast.WS.Acc = {ammo="Falcon Eye",
			      ...
			      back=gear.melee_jse_back,waist="Fotia Belt",legs="Carmine Cuisses +1",feet=gear.herculean_acc_feet}
				  
	sets.precast.WS.FullAcc = {head="Carmine mask",neck="Iqabi necklace",ear1="Steelflash earring",ear2="Bladeborn Earring",
				  body="Adhemar Jacket",hands="Adhemar Wristbands",
			      back=gear.melee_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet="Jhakri pigaches +1"}
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Falcon Eye",head="Adhemar Bonnet",ear1="Moonshade Earring",ear2="Brutal Earring",ring1="Ramuh Ring",hands="Jhakri Cuffs +1",back="Laic Mantle"})
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Tanmogayi +1",sub="Colada",ammo="Falcon Eye",
	    ...
	    back=gear.melee_jse_back,waist="Anguinus Belt",legs="Jhakri Slops +1",feet=gear.herculean_acc_feet}
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
			      ...
			      body="Jhakri Robe +1",hands="Iuitl Wristbands +1",ring1="Defending Ring",ring2="Shneddick Ring",
	...
	sets.idle.PDT = {main="Nehushtan",sub="Genbu's Shield",ammo="Staunch Tathlum",
				...
				back="Iximulew cape",waist="Flume Belt",legs=gear.herculean_dt_legs,feet="Battlecast Gaiters"}
	...
	sets.Weapons = {main="Claidheamh Soluis", sub="Arasy Sword"}
	...
	sets.engaged = {ammo="Ginsen",
			    ...
			    body="Taeon tabard",hands="Adhemar Wristbands",ring1="Epona's Ring",ring2="Rajas Ring",
			    back="Rosmerta's Cape",waist="Windbuffet Belt +1",legs="Jhakri Slops +1",feet="Taeon Boots"}
	...
	sets.engaged.MinAcc = {ammo="Ginsen",
				...
				back=gear.melee_jse_back,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
				
	sets.engaged.SomeAcc = {ammo="Falcon Eye",
				head="Dampening Tam",neck="Combatant's Torque",ear1="Cessance Earring",ear2="Telos Earring",
				body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Epona's Ring",ring2="Petrov Ring",
				back=gear.melee_jse_back,waist="Windbuffet Belt +1",legs="Adhemar Kecks",feet=gear.herculean_acc_feet}
	...
	sets.engaged.HighAcc = {ammo="Falcon Eye",
				...
				back=gear.melee_jse_back,waist="Anguinus Belt",legs="Carmine Cuisses +1",feet=gear.herculean_acc_feet}
				
	sets.engaged.FullAcc = {ammo="Falcon Eye",
				head="Jhakri coronal +1",neck="Combatant's Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
				body="Jhakri Robe",hands="Jhakri Cuffs +1",ring1="Ramuh Ring",ring2="Rajas Ring",
				back="Laic mantle",waist="Anguinus belt",legs="Jhakri slops +1",feet="Jhakri Pigaches +1"}
