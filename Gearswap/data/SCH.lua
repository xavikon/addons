...
function handle_elemental(cmdParams)
	...
	elseif strategem == 'skillchain1' then
		...
		elseif state.ElementalMode.value == 'Fire' then
			send_command('input /p '..auto_translate('Liquefaction')..' -<t>- MB: '..auto_translate('Fire')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Stone" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Liquefaction')..' -<t>- MB: '..auto_translate('Fire')..' <scall21> CLOSE!;input /ma "Fire" <t>')
		elseif state.ElementalMode.value == 'Wind' then
			send_command('input /p '..auto_translate('Detonation')..' -<t>- MB: '..auto_translate('wind')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Stone" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Detonation')..' -<t>- MB: '..auto_translate('wind')..' <scall21> CLOSE!;input /ma "Aero" <t>')
		elseif state.ElementalMode.value == 'Lightning' then
			send_command('input /p '..auto_translate('Impaction')..' -<t>- MB: '..auto_translate('Thunder')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Water" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Impaction')..' -<t>- MB: '..auto_translate('Thunder')..' <scall21> CLOSE!;input /ma "Thunder" <t>')
		elseif state.ElementalMode.value == 'Light' then
			send_command('input /p '..auto_translate('Transfixion')..' -<t>- MB: '..auto_translate('Light')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Noctohelix" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Transfixion')..' -<t>- MB: '..auto_translate('Light')..' <scall21> CLOSE!;input /ma "Luminohelix" <t>')
		elseif state.ElementalMode.value == 'Earth' then
			send_command('input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Fire" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> CLOSE!;input /ma "Stone" <t>')
		elseif state.ElementalMode.value == 'Ice' then
			send_command('input /p '..auto_translate('Induration')..' -<t>- MB: '..auto_translate('ice')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Water" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Induration')..' -<t>- MB: '..auto_translate('ice')..' <scall21> CLOSE!;input /ma "Blizzard" <t>')
		elseif state.ElementalMode.value == 'Water' then
			send_command('input /p '..auto_translate('Reverberation')..' -<t>- MB: '..auto_translate('Water')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Stone" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Reverberation')..' -<t>- MB: '..auto_translate('Water')..' <scall21> CLOSE!;input /ma "Water" <t>')
		elseif state.ElementalMode.value == 'Dark' then
			send_command('input /p '..auto_translate('Compression')..' -<t>- MB: '..auto_translate('Darkness')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Blizzard" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Compression')..' -<t>- MB: '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
		end
	...
	elseif strategem == 'skillchain2' then
		...
		elseif not (buffactive['dark arts']  or buffactive['addendum: black']) then
			...
			send_command('input /ja "Dark Arts" <me>')
		elseif state.ElementalMode.value == 'Fire' then
			send_command('input /p '..auto_translate('Fusion')..' -<t>- MB: '..auto_translate('Fire')..' '..auto_translate('Light')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Fire" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Fusion')..' -<t>- MB: '..auto_translate('Fire')..' '..auto_translate('Light')..' <scall21> CLOSE!;input /ma "Thunder" <t>')
		elseif state.ElementalMode.value == 'Wind' then
			send_command('input /p '..auto_translate('Fragmentation')..' -<t>- MB: '..auto_translate('wind')..' '..auto_translate('Thunder')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Blizzard" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Fragmentation')..' -<t>- MB: '..auto_translate('wind')..' '..auto_translate('Thunder')..' <scall21> CLOSE!;input /ma "Water" <t>')
		elseif state.ElementalMode.value == 'Lightning' then
			send_command('input /p '..auto_translate('Fragmentation')..' -<t>- MB: '..auto_translate('wind')..' '..auto_translate('Thunder')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Blizzard" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Fragmentation')..' -<t>- MB: '..auto_translate('wind')..' '..auto_translate('Thunder')..' <scall21> CLOSE!;input /ma "Water" <t>')
		elseif state.ElementalMode.value == 'Light' then
			send_command('input /p '..auto_translate('Fusion')..' -<t>- MB: '..auto_translate('Fire')..' '..auto_translate('Light')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Fire" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Fusion')..' -<t>- MB: '..auto_translate('Fire')..' '..auto_translate('Light')..' <scall21> CLOSE!;input /ma "Thunder" <t>')
		elseif state.ElementalMode.value == 'Earth' then
			send_command('input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Aero" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
		elseif state.ElementalMode.value == 'Ice' then
			send_command('input /p '..auto_translate('Distortion')..' -<t>- MB: '..auto_translate('ice')..' '..auto_translate('Water')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Luminohelix" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Distortion')..' -<t>- MB: '..auto_translate('ice')..' '..auto_translate('Water')..' <scall21> CLOSE!;input /ma "Stone" <t>')
		elseif state.ElementalMode.value == 'Water' then
			send_command('input /p '..auto_translate('Distortion')..' -<t>- MB: '..auto_translate('ice')..' '..auto_translate('Water')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Luminohelix" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Distortion')..' -<t>- MB: '..auto_translate('ice')..' '..auto_translate('Water')..' <scall21> CLOSE!;input /ma "Stone" <t>')
		elseif state.ElementalMode.value == 'Dark' then
			send_command('input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> OPEN!;input /ja "Immanence" <me>;wait 1;input /ma "Aero" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
	...
	elseif strategem == 'skillchain4' then
		...
		elseif not (buffactive['dark arts']  or buffactive['addendum: black']) then
			...
			send_command('input /p Starting 4-Step '..auto_translate('Skillchain')..' -<t>-;input /ja "Immanence" <me>;wait 1;input /ma "Aero" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Stone" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Water" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Thunder" <t>;')
		end
	...
	elseif strategem == 'skillchain6' then
		...
		elseif not (buffactive['Immanence']) then
			add_to_chat(123,'Immanence not active, wait 30 seconds before restarting. - Activating.')
			send_command('input /ja "Immanence" <me>')
		else 
			send_command('input /p Starting 6-Step '..auto_translate('Skillchain')..' -<t>-;input /ma "Aero" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Stone" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Water" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Thunder" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Fire" <t>;wait 4;input /ja "Immanence" <me>;wait 1;input /ma "Thunder" <t>')
		end
	...
	elseif strategem == 'wsskillchain' then
		...
		elseif not (buffactive['dark arts']  or buffactive['addendum: black']) then
			...
			send_command('input /ja "Dark Arts" <me>')
		elseif state.ElementalMode.value == 'Fire' then
			send_command('input /p '..auto_translate('Liquefaction')..' -<t>- MB: '..auto_translate('Fire')..' <scall21> OPEN!;input /ws "Rock Crusher" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Liquefaction')..' -<t>- MB: '..auto_translate('Fire')..' <scall21> CLOSE!;input /ma "Fire" <t>')
		elseif state.ElementalMode.value == 'Wind' then
			send_command('input /p '..auto_translate('Detonation')..' -<t>- MB: '..auto_translate('wind')..' <scall21> OPEN!;input /ws "Rock Crusher" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Detonation')..' -<t>- MB: '..auto_translate('wind')..' <scall21> CLOSE!;input /ma "Aero" <t>')
		elseif state.ElementalMode.value == 'Lightning' then
			send_command('input /p '..auto_translate('Impaction')..' -<t>- MB: '..auto_translate('Thunder')..' <scall21> OPEN!;input /ws "Starburst" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Impaction')..' -<t>- MB: '..auto_translate('Thunder')..' <scall21> CLOSE!;input /ma "Thunder" <t>')
		elseif state.ElementalMode.value == 'Light' then
			send_command('input /p '..auto_translate('Transfixion')..' -<t>- MB: '..auto_translate('Light')..' <scall21> OPEN!;input /ws "Starburst" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Transfixion')..' -<t>- MB: '..auto_translate('Light')..' <scall21> CLOSE!;input /ma "Luminohelix" <t>')
		elseif state.ElementalMode.value == 'Earth' then
			if player.sub_job == 'WHM' then
				send_command('input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> OPEN!;input /ws "Earth Crusher" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> CLOSE!;input /ma "Stone" <t>')
			else
				send_command('input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> OPEN!;input /ws "Shell Crusher" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Scission')..' -<t>- MB: '..auto_translate('earth')..' <scall21> CLOSE!;input /ma "Stone" <t>')
			end
		elseif state.ElementalMode.value == 'Ice' then
			send_command('input /p '..auto_translate('Induration')..' -<t>- MB: '..auto_translate('ice')..' <scall21> OPEN!;input /ws "Starburst" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Induration')..' -<t>- MB: '..auto_translate('ice')..' <scall21> CLOSE!;input /ma "Blizzard" <t>')
		elseif state.ElementalMode.value == 'Water' then
			send_command('input /p '..auto_translate('Reverberation')..' -<t>- MB: '..auto_translate('Water')..' <scall21> OPEN!;input /ws "Omniscience" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Reverberation')..' -<t>- MB: '..auto_translate('Water')..' <scall21> CLOSE!;input /ma "Water" <t>')
		elseif state.ElementalMode.value == 'Dark' then
			if player.sub_job == 'WHM' then
				send_command('input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> OPEN!;input /ws "Earth Crusher" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Gravitation')..' -<t>- MB: '..auto_translate('earth')..' '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
			else
				send_command('input /p '..auto_translate('Compression')..' -<t>- MB: '..auto_translate('Darkness')..' <scall21> OPEN!;input /ws "Omniscience" <t>;wait 5;input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Compression')..' -<t>- MB: '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
			end
		end
	...
	elseif strategem == 'endskillchain' then
		...
		elseif not (buffactive['dark arts']  or buffactive['addendum: black']) then
			...
			send_command('input /ja "Dark Arts" <me>')
		elseif state.ElementalMode.value == 'Fire' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('Fire')..' <scall21> CLOSE!;input /ma "Fire" <t>')
		elseif state.ElementalMode.value == 'Wind' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('wind')..' <scall21> CLOSE!;input /ma "Aero" <t>')
		elseif state.ElementalMode.value == 'Lightning' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('Thunder')..' <scall21> CLOSE!;input /ma "Thunder" <t>')
		elseif state.ElementalMode.value == 'Light' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('Light')..' <scall21> CLOSE!;input /ma "Luminohelix" <t>')
		elseif state.ElementalMode.value == 'Earth' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('earth')..' <scall21> CLOSE!;input /ma "Stone" <t>')
		elseif state.ElementalMode.value == 'Ice' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('ice')..' <scall21> CLOSE!;input /ma "Blizzard" <t>')
		elseif state.ElementalMode.value == 'Water' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('Water')..' <scall21> CLOSE!;input /ma "Water" <t>')
		elseif state.ElementalMode.value == 'Dark' then
			send_command('input /ja "Immanence" <me>;wait 1;input /p '..auto_translate('Skillchain')..' -<t>- MB: '..auto_translate('Darkness')..' <scall21> CLOSE!;input /ma "Noctohelix" <t>')
		end
...
function get_current_strategem_count()
    ...
    local fullRechargeTime = maxStrategems*StratagemChargeTimer
