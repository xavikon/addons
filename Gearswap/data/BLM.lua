...
function job_post_midcast(spell, action, spellMap, eventArgs)
    ...
    elseif spell.skill == 'Elemental Magic' and default_spell_map ~= 'ElementalEnfeeble' and spell.english ~= 'Impact' then
		...
		if player.hpp < 75 and player.tp < 1000 and (state.CastingMode.value == 'Normal' or state.CastingMode.value == 'Fodder') then
			if player.inventory["Sorcerer's Ring"] or player.wardrobe["Sorcerer's Ring"] or player.wardrobe2["Sorcerer's Ring"] or player.wardrobe3["Sorcerer's Ring"] or player.wardrobe4["Sorcerer's Ring"] then
